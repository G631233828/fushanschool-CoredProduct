...
<div class="banner" style="height: 250px;">
	<div class="slider" >
        <div class="flexslider"  style="height: 250px;">
         <!--  <ul class="slides">
            <li> --><img style="width:1240px;height: 250px;margin-left: 0px;"  
             src="${pageContext.request.contextPath}/assets/web/mainWeb/image/banana2016.jpg" alt=""/>
           <!--  </li>
          </ul> -->
        </div>
    </div>
