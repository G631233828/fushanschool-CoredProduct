    	...
    	<div class="i_mam" style="width:200px">
        	...
        	<div class="scd_r">
			        ...
			        <div class="i_mbr">
						...
						<a class="navlinks"
							href="${pageContext.request.contextPath}/web/civilization/${year }/select?pageNo=${newslist.upPage}&name=${name}">&lt;
							上一页</a>
							...
							<c:choose>
								<c:when test="${nav == pageList.pageNo}">
									...
									<a class="navlinks"
										...
										href="${pageContext.request.contextPath}/web/civilization/${year }/select?pageNo=${nav}&name=${name}">
										${nav}</a>
								</c:when>
								<c:otherwise>
									<a class="navlinks"
						...
						<a class="navlinks"
							href="${pageContext.request.contextPath}/web/civilization/${year }/select?pageNo=${newslist.nextPage}&name=${name}">下一页
							></a>
