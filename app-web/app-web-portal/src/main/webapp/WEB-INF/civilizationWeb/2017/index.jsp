...
<body style=" width:1024px; margin:0px auto;">
	...
	<div style="background-image:url(${pageContext.request.contextPath}/assets/web/2017/2017_fushang_bg.jpg); background-repeat:no-repeat;width:1024px; height:768px;">
	<div style="width:1024px; height:167px;">
		<div class="top">
			<ul>
				<li style="margin-top: -5px;">
				
				<img  src="${pageContext.request.contextPath}/assets/web/2017/2017-fushang-logo.png" /></li>
		...
		<div style="width:1024px;height: 200px; margin-top: 393px; text-align: center;" >
				...
				<span style="color:#f1c62f;font-size:18px; font-weight:bold;">
				外语节活动报道</span>
				<ul style="text-align: left;color: #fff;">
					...
					<c:forEach items="${pageList.datas}" var="item" varStatus="status">
						...
						<div style="float: left;">
							<img  height="20px" width="20px" alt="${item.title}" src="${pageContext.request.contextPath}/assets/web/2017/mind_xc.png">
						</div>
