...
<body>
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td class="center">
                                         	<button type="button" class="btn btn-primary btn-xs edit-news" data-id="1"
                                         	 ...
                                         	 '${item.edate}','${item.type}','${item.message}')">编辑</button>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                      ...
                      <div class="col-lg-12">
                      		 <div class="form-group">
                            <label class="col-sm-1 control-label">理由</label>
                            <div class="col-sm-11">
					...
					<!-- idcode=1 表示是请假 -->
					<input id="idCode" name="idCode" type="hidden" value="1">
                <div class="modal-footer">
                    <button type="button" class="btn btn-white" data-dismiss="modal">关闭</button>
 ...
 <script type="text/javascript">
 	...
 	// onclick="updateFormValue('${item.id}','${item.name}','${item.sdate}',
     //                                    	 '${item.edate}','${item.type}','${item.message}')">编辑</button>
 	function updateFormValue(id,name,sdate,edate,type,message){
 		$('#myModal5').modal('show');
 		$("#id").val(id);
		$("#name").val(name);
		$("#sdate").val(sdate);
 	...
 	function deleteById() {
 		...
 		window.location.href = "delete?idCode=1&id="+deleteId;
 	}
