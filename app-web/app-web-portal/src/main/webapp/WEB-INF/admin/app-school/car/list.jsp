...
<body>
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td class="center">
                                         	<button type="button" class="btn btn-primary btn-xs edit-news" data-id="1"
                                         	 onclick="updateFormValue('${item.id}','${item.name}','${item.sdate}',
                                         	 '${item.edate}','${item.dempartment}','${item.message}')">编辑</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                      ...
                      <div class="col-lg-12">
                            ...
                            <div class="col-sm-10">
                            	<textarea id="message" name="message" data-rangelength="[2,1000]" placeholder="备注" class="form-control parsley-validated" rows="6"></textarea>
                            </div>
                        </div>
                        </div>
                      </div>
					...
					<!-- idcode=1 表示是请假 -->
					<input id="idCode" name="idCode" type="hidden" value="3">
                <div class="modal-footer">
                    <button type="button" class="btn btn-white" data-dismiss="modal">关闭</button>
 ...
 <script type="text/javascript">
 	//更新内容传值
 	function updateFormValue(id,name,sdate,edate,dempartment,message){
 		$('#myModal5').modal('show');
 		$("#id").val(id);
		$("#name").val(name);
		$("#sdate").val(sdate);
		$("#edate").val(edate);
		//$("#dempartment").val("123123");
		$("#message").val(message);
		 $("#dempartment").find("option[value='"+dempartment+"']").attr("selected", "selected");
		
		//标题设置，先清空再添加
		$("#panelTitle").empty();
		$("#panelTitle").append("更新用车申请"); 
 	}
 	//添加时－清空值
 	...
 	function deleteById() {
 		...
 		window.location.href = "delete?idCode=3&id="+deleteId;
 	}
