...
<body>
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td class="center">
                                         	<button type="button" class="btn btn-primary btn-xs edit-news" data-id="1"
                                         	 onclick="updateFormValue('${item.id}','${item.name}','${item.subjectNum}',
                                         	 '${item.remark}')">编辑</button>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                 ...
                 <form id="add-news-form" action="${pageContext.request.contextPath}/subject/createOrUpdateToFind" 
                      ...
                      <div class="row">
                      	<div class="col-lg-6">
	                      	 <div class="form-group">
	                            ...
	                            <div class="col-sm-10">
	                                <input required="" aria-required="true" type="text" id="name" name="name" class="form-control" placeholder="科目名称" >
	                            </div>
	                        </div>
                      	</div>
                      	<div class="col-lg-6">
                      		 <div class="form-group">
	                            ...
	                            <div class="col-sm-10">
	                                <input required="" aria-required="true" type="text" id="subjectNum" name="subjectNum" class="form-control" placeholder="编号" >
	                            </div>
                        	</div>
 ...
 <script type="text/javascript">
 	//更新内容传值
 	function updateFormValue(id,name,subjectNum,remark){
 		$('#myModal5').modal('show');
 		$("#id").val(id);
		$("#name").val(name);
